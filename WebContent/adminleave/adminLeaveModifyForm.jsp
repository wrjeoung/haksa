...
<form action="adminleaveinfoPro.do" method="post" enctype="multipart/form-data" onSubmit="" name="">
	<input type="hidden" name="num" value="${leave.num }"/> 
	<table border="1" width="1100" cellspacing="0" cellpadding="0" align="center">
		...
		<tr align="center">
			...
			&nbsp;<input type="text" name="leavegyul" size="20" value="${leave.leavegyul }">
			</td>
		</tr>
		<tr align="center">
			<td width="280" bgcolor="#BDBDBD">제적사유</td>
			<td width="520" align="left">&nbsp;<select name="leavesayu"><option>선택</option></select>
			&nbsp;<input type="text" name="leavesayu2" size="40" value="${leave.leavesayu2 }"></td>
